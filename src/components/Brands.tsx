        ...
        lang === "ko"
          ? [
              { label: "콘셉트", value: "정통 한식 프리미엄 BBQ 다이닝" },
              {
                label: "타깃 고객",
                value:
                  "가족 단위 고객, 비즈니스 모임, 한국 문화를 체험하고자 하는 외국인",
              },
              {
                label: "운영 특징",
                value:
                  "고품질 원육과 신선한 식재료를 바탕으로 단체 회식과 가족 모임까지 수용 가능한 프리미엄 운영 모델",
              },
              {
                label: "대표 메뉴",
                value: "우삼겹, 꽃살, 된장찌개, 돌솥비빔밥",
              },
          ...
          : [
              {
                label: "Concept",
                value: "Authentic Korean Premium BBQ Dining",
              },
              {
                label: "Target",
                value:
                  "Families, Business Meetings, Foreigners experiencing Korean culture",
              },
              {
                label: "Operation",
                value:
                  "Premium operation model accommodating large groups and family gatherings with high-quality meat and fresh ingredients",
              },
              {
                label: "Signature",
                value:
                  "Woosamgyeop, Kkotsal, Doenjang-jjigae, Dolsot Bibimbap",
              },
        ...
        lang === "ko"
          ? [
              { label: "콘셉트", value: "숯불 직화 BBQ 기반 한국식 캐주얼 다이닝" },
              {
                label: "타깃 고객",
                value:
                  "직장인, 20~40대 고객층, 연인 등 가성비 한식 안주 수요 고객",
              },
              {
                label: "운영 특징",
                value:
                  "점심에는 간편한 식사, 저녁에는 푸짐한 BBQ와 주류를 즐길 수 있으며 내점·포장·배달이 모두 가능한 유연한 운영 모델",
              },
              {
                label: "대표 메뉴",
                value: "열탄불고기, 7분돼지김치, 삼겹살, 옛날도시락",
              },
          ...
          : [
              {
                label: "Concept",
                value: "Korean Casual Dining based on Charcoal BBQ",
              },
              {
                label: "Target",
                value:
                  "Office workers, 20s-40s, Couples looking for cost-effective Korean food",
              },
              {
                label: "Operation",
                value:
                  "Flexible model for lunch, dinner BBQ/drinks, dine-in, takeout, and delivery",
              },
              {
                label: "Signature",
                value:
                  "Yeoltan Bulgogi, 7-Minute Pork Kimchi Stew, Samgyeopsal, Yetnal Dosirak",
              },
        ...
        lang === "ko"
          ? [
              { label: "콘셉트", value: "합리적인 가격의 캐주얼 중식 전문 브랜드" },
              {
                label: "타깃 고객",
                value:
                  "가족 단위 고객, 학생, 직장인 등 빠르고 부담 없는 식사를 선호하는 소비",
              },
              {
                label: "운영 특징",
                value:
                  "소형 매장 중심 운영으로 배달·테이크아웃에 최적화된 효율적인 운영 구조",
              },
              {
                label: "대표 메뉴",
                value: "짜장면, 짬뽕, 탕수육, 볶음밥",
              },
          ...
          : [
              {
                label: "Concept",
                value: "Reasonably priced Casual Chinese Brand",
              },
              {
                label: "Target",
                value:
                  "Families, Students, Office workers seeking quick, affordable meals",
              },
              {
                label: "Operation",
                value:
                  "Efficient structure optimized for small stores, delivery, and takeout",
              },
              {
                label: "Signature",
                value: "Jjajangmyeon, Jjamppong, Tangsuyuk, Fried Rice",
              },
                    ...
                    {brand.menus.map((menu, menuIndex) => (
                      ...
                      >
                        ...
                        <p
                          className={
                            lang === "en" &&
                            menu.name === "7-Minute Pork Kimchi Stew"
